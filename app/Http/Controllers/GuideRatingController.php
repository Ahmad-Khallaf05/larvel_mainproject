...
class GuideRatingController extends Controller
{
    ...
    public function store(Request $request, $guideId)
    {
        ...
        // Check if the user has already rated this guide
        $existingRating = Guide_Rating::where('guide_id', $guideId)
    ...
    {
        // Allow the deletion of a rating, could be useful for moderation.
        $guide_rating->delete();
